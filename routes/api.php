...
//    return $request->user();
//});
Route::Post('/login/login', [\App\Http\Controllers\Auth\ApiAuthController::class, 'login']);

Route::group(['middleware' => ['auth:sanctum']], function () {
    Route::match(['get', 'options', 'post'], '/task/list', [\App\Http\Controllers\Ppsd\TaskController::class, 'getTasks']);
